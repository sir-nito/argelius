                ...
                bcrypt.hash(params.password, null, null, (err, hash) => {
                    ...
                    usuario.save((err, userStored) => {
                        ...
                        if (userStored) {
                            ...
                            var mensaje = "Hola le damos la binevenida a Sisvis";
                            ...
                            var mailOptions = {
                                ...
                                html: '<href>http://40.117.253.59/api/validar/' + userStored._id + '</href>'
                            };
                            ...
                            transporter.sendMail(mailOptions, function(error, info) {
                                if (error) {
                                    ...
                                    return res.status(200).send({ message: 'revisa tu correo' });
                                }
                            });
                        } else {
...
function IniciarSession(req, res) {
    ...
    User.findOne({ correo: correo }, (err, user) => {
        ...
        if (user.status == 'ACTIVADA' && user.version == 'MRC32') {
            User.findOne({ correo: correo }, (err, user) => {
